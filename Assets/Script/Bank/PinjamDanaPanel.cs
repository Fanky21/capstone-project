...
public class PinjamDanaPanel : MonoBehaviour
{
    [Header("UI Panel")]
    [SerializeField] private GameObject panelPeminjaman;   
    ...
    private void Start()
    {
        ...
        if (panelPeminjaman != null)
            panelPeminjaman.SetActive(false);
    }
    ...
    {
        panelOpen = true;
        panelPeminjaman.SetActive(true);
